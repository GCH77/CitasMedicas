...
public class BackendcitasApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        personas.add(new Persona("Juan", "Cardozo", "jcardozo@email.com", 310250255, LocalDate.of(1985,3,16), documentos.get(0), 1118555888));
        personas.add(new Persona("Alvarito", "Uribe", "auc@email.com", 310250315, LocalDate.of(1984, 7, 16), documentos.get(0), 111855228));
        personas.add(new Persona("Carlos Humberto", "Valderrama", "pibe@email.com", 310250875, LocalDate.of(1988, 10, 20), documentos.get(0), 1118545888));
        personas.add(new Persona("Pablo", "Escobar", "elpatron@email.com", 310250875, LocalDate.of(1990, 5, 25), documentos.get(0), 1118545888));
